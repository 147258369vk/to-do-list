...
mongoose.connect('mongodb+srv://robinsinghkamboj:robinsingh@cluster0-rneh1.gcp.mongodb.net/to-do-list?retryWrites=true&w=majority&connectTimeoutMS=500000&bufferCommands=false', { useNewUrlParser: true,keepAlive: true, keepAliveInitialDelay: 300000,useUnifiedTopology:true}, (err) => {
    if(!err) {
